...
export const BLOG_POSTS: BlogPost[] = [
    {
        id: '1',
        title: 'How AI is Revolutionizing Digital Design in 2026',
        excerpt: 'The intersection of artificial intelligence and creative craft is producing results we never thought possible. Explore the future of automated aesthetics.',
        content: `
    ...
    {
        id: '2',
        title: 'The Secret to High-Converting Canva Templates',
        excerpt: 'Consistency and psychological triggers are the backbone of any template that sells. Learn our top 5 tips for viral template design.',
        content: `
    ...
    `,
        ...
        readTime: '8 min',
        tags: ['Canva', 'Templates', 'Marketing', 'Passive Income']
    },
    {
        id: '3',
        title: 'Oflex Studio: Our Brand Evolution Journey',
        excerpt: 'Behind the scenes of our recent rebrand. Why we moved towards glassmorphism and high-performance digital aesthetics.',
        content: `
    ...
    `,
        ...
        author: 'Founder',
        date: 'Jan 12, 2026',
        image: 'https://images.unsplash.com/photo-1550745165-9bc0b252728f?auto=format&fit=crop&q=80&w=800',
        readTime: '4 min',
        tags: ['Branding', 'Studio', 'Growth', 'Behind The Scenes']
    },
    {
        id: '4',
        title: 'Mastering Prompt Engineering for Visual Artists',
        excerpt: 'Words are the new brushes. A comprehensive guide on structuring prompts to get exactly what you visualize in AI image generators.',
        content: `
    ...
    `,
        ...
        readTime: '12 min',
        tags: ['AI Prompting', 'Creative Guide', 'Art', 'Workflow']
    }
];
